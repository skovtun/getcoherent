...
Currently registered shared components:

- CID-007 LandingNav (layout) — Auto-detected from components/landing-nav.tsx
  Import: import { LandingNav } from '@/components/shared/components/landing-nav'
  Used in: app/page.tsx

- CID-004 CopyableBlock (widget) — Auto-detected from components/copyable-terminal.tsx
  Import: import { CopyableBlock } from '@/components/shared/components/copyable-terminal'
  Used in: app/page.tsx

- CID-003 CopyableInline (widget) — Auto-detected from components/copyable-terminal.tsx
  Import: import { CopyableInline } from '@/components/shared/components/copyable-terminal'
  Used in: app/page.tsx

- CID-006 FloatingSnippets (widget) — Auto-detected from components/hero-effects.tsx
  Import: import { FloatingSnippets } from '@/components/shared/components/hero-effects'
  Used in: app/page.tsx

- CID-005 ParticleDotGrid (widget) — Auto-detected from components/hero-effects.tsx
  Import: import { ParticleDotGrid } from '@/components/shared/components/hero-effects'
  Used in: app/page.tsx
