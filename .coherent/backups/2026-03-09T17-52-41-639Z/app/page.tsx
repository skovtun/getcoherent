                ...
                <div className="flex flex-col items-center text-center gap-4">
                  ...
                  {Array.isArray(step.cmd) ? (
                    <div className="w-full space-y-2">
                      {step.cmd.map((c, j) => (
                        <div key={j} className="rounded-xl border border-border/15 bg-background/80 px-4 py-3 font-mono text-sm text-primary text-left">
                    ...
                    <div className="w-full rounded-xl border border-border/15 bg-background/80 px-4 py-3 font-mono text-sm text-primary text-left">
                      <span className="text-muted-foreground select-none">$ </span>
                      {step.cmd}
                    </div>
                  )}
            ...
            <AnimateOnScroll delay={100}>
              <div className="rounded-xl border border-border/10 bg-card p-6 md:p-8 h-full flex flex-col transition-all duration-300 hover:border-border/20 hover:shadow-sm hover:shadow-primary/5 hover:-translate-y-0.5">
                ...
                <div className="space-y-2">
                  {TWO_WAYS_CLI_CMDS.map((c, i) => (
                    <div key={i} className="rounded-lg border border-border/10 bg-background/80 px-3 py-2 font-mono text-sm text-primary">
                      <span className="text-muted-foreground select-none">$ </span>
                      {c}
                    </div>
                  ))}
              ...
              <div className="rounded-xl border border-border/10 bg-card p-6 md:p-8 h-full flex flex-col transition-all duration-300 hover:border-border/20 hover:shadow-sm hover:shadow-primary/5 hover:-translate-y-0.5">
                ...
                <div className="space-y-2">
                  {TWO_WAYS_PROMPTS.map((prompt, i) => (
                    <div key={i} className="rounded-lg border border-border/10 bg-background/50 px-3 py-2 font-mono text-sm text-foreground/80">
                      &quot;{prompt}&quot;
                    </div>
                  ))}
                </div>
