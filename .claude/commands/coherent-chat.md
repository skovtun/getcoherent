...
**Protocol version: 2.** Every `coherent _phase ...` call below carries `--protocol 2` so CLI/markdown drift is caught at the first ingest, not silently halfway through the run.
