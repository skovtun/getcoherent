...
No shared components yet. Register with: coherent components shared add <name> --type layout|section|widget
...
Run after changes:
- coherent validate — quality + accessibility checks
- coherent doctor — auto-fix cache, deps, syntax
- coherent audit — shared component consistency
